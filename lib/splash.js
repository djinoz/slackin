...
export default function splash({ name, logo, active, total, channels, iframe }){
  let div = dom('.splash',
    ...
    dom('p',
      '<h1>Xamarin Evolve Conference</h1> \
       Want to stay in touch with others at the conference?<br/> \
       Make Session Notes and share them?<br/> \
       Figure out where/when to meetup?<br/> \
       Then.... Join ', dom('b', name),
    ...
    dom('p.status',
      active
        ? [
          ...
          dom('b.total', total), ' registered - test dj.'
        ]
    ...
    !iframe && dom('footer',
      '<h2>Sponsored by</h2> \
      <img src="https://dashboard.streethawk.com/dashboard/public/img/global/2015-sh-logo-white.png"/><br/><br/>
      powered by ',
