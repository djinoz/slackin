...
export default function splash({ name, logo, active, total, channels, iframe }){
  let div = dom('<h1 style="width:80%;text-align:center;margin:auto;">Xamarin Evolve</h1>', 
    '<h2 style="width:80%;text-align:center;margin:auto;">Share session notes and chat with others attendees.</h2>', 
    dom('.splash',
    !iframe && dom('.logos',
      logo && dom('.logo.org'),
      dom('.logo.slack')
