...
export default function splash({ name, logo, active, total, channels, iframe }){
  let div = dom('#content', '<h1 style="width:80%;text-align:center;margin:auto;">Xamarin Evolve Slack</h1>',
    dom('.splash',
    !iframe && dom('.logos',
      logo && dom('.logo.org'),
      dom('.logo.slack')
    ...
    dom('p',
       'Share session notes and stay in touch with others. Join ', dom('b', name),
    ...
    !iframe && dom('footer',
      '<h2>Sponsored by</h2> \
      <img style="width:60%" src="https://dashboard.streethawk.com/dashboard/public/img/global/2015-sh-logo.png"/><br/><br/> \
      powered by ',
